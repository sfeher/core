...
public class ImageUploadPanel extends Panel implements IResourceListener {
    ...
    private final ResourceReference resRef;
    private final PageParameters imageParams;
    
    public ImageUploadPanel(String pId, String uploadFolderPath, ResourceReference resRef,PageParameters params) {
        super(pId);
    ...
    public ImageUploadPanel(String pId, String uploadFolderPath) {
        this(pId, uploadFolderPath,null,null);
    }
                    ...
                    modalWindow.getContentId(), uploadFolderPath) {
                        ...
                        public void onImageUploaded(
                                ...
                                AjaxRequestTarget pTarget) {
                                    ...
                                    XmlTag xmlImageTag;
                                    if(resRef==null) {
                                        url=ImageUploadPanel.this.urlFor(IResourceListener.INTERFACE, null);
                                        xmlImageTag = ImageUploadHelper.createImageTag(pImageFileDescription, url);
                                        pTarget.appendJavaScript("putImage('"
                                            + xmlImageTag.toString() + "');");

                                    } else {
                                        url=ImageUploadPanel.this.urlFor(resRef, imageParams);
                                        url = "<img src="+url+"</img>";
                                        pTarget.appendJavaScript("putImage('"
                                            + url.toString() + "');");
